...
ActiveRecord::Schema.define(version: 20_210_123_030_747) do
  ...
  create_table 'articles', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.uuid 'sell_account_id'
    t.uuid 'buy_account_id'
    t.uuid 'inv_account_id'
    t.uuid 'sell_account_tax_id'
    t.uuid 'buy_account_tax_id'
    t.uuid 'company_id'
    t.uuid 'articles_group_id'
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
  ...
  create_table 'articles_groups', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    t.string 'name'
    t.uuid 'company_id'
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
  ...
  create_table 'companies', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.uuid 'base_currency_id'
    t.uuid 'secondary_currency_id'
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
