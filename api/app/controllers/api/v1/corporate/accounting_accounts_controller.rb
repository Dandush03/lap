...
module Api
  module V1
    module Corporate
      ...
      class AccountingAccountsController < CorporateController
        def index
        ...
        def create
          ...
          if account.valid?
            account.save!
            return render json: { account: account, message: 'created successfuly' },
                          status: :created
          end
          msg = account.errors.messages
          render json: { account: account, message: msg }, status: :ok
        end
