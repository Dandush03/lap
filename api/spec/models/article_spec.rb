...
RSpec.describe Article, type: :model do
  ...
  describe 'belong to account' do
    it { should belong_to(:buy_account).class_name('AccountingAccount').with_foreign_key('buy_account_id').without_validating_presence }
    it { should belong_to(:sell_account).class_name('AccountingAccount').with_foreign_key('sell_account_id').without_validating_presence }
    it { should belong_to(:inv_account).class_name('AccountingAccount').with_foreign_key('inv_account_id').without_validating_presence }
  end
