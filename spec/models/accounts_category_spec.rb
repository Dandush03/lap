...
RSpec.describe AccountsCategory, type: :model do
  ...
  it { should have_many(:buy_articles).class_name('Article').with_foreign_key('buy_account_id') }
  it { should have_many(:sell_articles).class_name('Article').with_foreign_key('sell_account_id') }
  it { should have_many(:inv_articles).class_name('Article').with_foreign_key('sell_account_id') }
